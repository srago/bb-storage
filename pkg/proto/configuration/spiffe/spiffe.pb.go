...
type SubjectMatcher struct {
	...
	AllowedSpiffeIds map[string]string `protobuf:"bytes,1,rep,name=allowed_spiffe_ids,json=allowedSpiffeIds,proto3" json:"allowed_spiffe_ids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_pkg_proto_configuration_spiffe_spiffe_proto_rawDesc = []byte{
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x73, 0x70, 0x69, 0x66, 0x66, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_pkg_proto_configuration_spiffe_spiffe_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_proto_configuration_spiffe_spiffe_proto_goTypes = []any{
	(*SubjectMatcher)(nil), // 0: buildbarn.configuration.spiffe.SubjectMatcher
	nil,                    // 1: buildbarn.configuration.spiffe.SubjectMatcher.AllowedSpiffeIdsEntry
}
var file_pkg_proto_configuration_spiffe_spiffe_proto_depIdxs = []int32{
	1, // 0: buildbarn.configuration.spiffe.SubjectMatcher.allowed_spiffe_ids:type_name -> buildbarn.configuration.spiffe.SubjectMatcher.AllowedSpiffeIdsEntry
