...
type tlsPeerCertificateAuthenticator struct {
	mu              sync.Mutex
...
func NewTLSClientCertificateAuthenticator(clientCAs *x509.CertPool, clock clock.Clock, allowedSubjects *spiffe.SubjectMatcher,
	...
	return &tlsPeerCertificateAuthenticator{
...
func (a *tlsPeerCertificateAuthenticator) handleRotatedCA() {
...
// Caller must hold mutex.
func (a *tlsPeerCertificateAuthenticator) verifyPeer(certs []*x509.Certificate, usage x509.ExtKeyUsage) error {
...
func (a *tlsPeerCertificateAuthenticator) Authenticate(ctx context.Context) (context.Context, error) {
	a.mu.Lock()
	defer a.mu.Unlock()
	a.handleRotatedCA()
...
func (a *tlsPeerCertificateAuthenticator) GetVerifyCertificate(usage x509.ExtKeyUsage) func(rawCerts [][]byte, _ [][]*x509.Certificate) (error) {
