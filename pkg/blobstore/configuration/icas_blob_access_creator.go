...
func (bac *icasBlobAccessCreator) NewBlockListGrowingPolicy(currentBlocks, newBlocks int) (local.BlockListGrowingPolicy, error) {
	if newBlocks != 1 {
	...
	return local.NewMutableBlockListGrowingPolicy(currentBlocks), nil
}
