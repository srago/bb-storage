...
func (bac *casBlobAccessCreator) NewBlockListGrowingPolicy(currentBlocks, newBlocks int) (local.BlockListGrowingPolicy, error) {
	return local.NewImmutableBlockListGrowingPolicy(currentBlocks, newBlocks), nil
}
