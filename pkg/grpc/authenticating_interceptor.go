...
func NewAuthenticatingUnaryInterceptor(a authenticator.Authenticator) grpc.UnaryServerInterceptor {
...
// gRPC server.
func NewAuthenticatingStreamInterceptor(a authenticator.Authenticator) grpc.StreamServerInterceptor {
